...
public class ProdutoDAO {
    ...
    public boolean inserir(Produto produto) {
        String sql = "INSERT INTO PRODUTOS (NOME,DESCRICAO,CODIGO_BARRAS,VALIDADE,UNIDADE,QUANTIDADE_MINIMA) VALUES (?,?,?,?,?,?)";
    ...
    public List<Produto> listarTodos() {
        ...
        try (Connection conn = ConexaoBD.getConnection();
            ...
            while (rs.next()) {
                ...
                p.setValidade(validade != null ? validade.toLocalDate() : null);
                p.setUnidade(rs.getString("UNIDADE"));
                p.setQuantidadeMinima(rs.getInt("QUANTIDADE_MINIMA"));
                produtos.add(p);
            }
